...
NPCAnim.CitizenMaleAnim["sit"] = "ACT_BUSY_SIT_GROUND"
...
NPCAnim.CitizenFemaleAnim["sit"] = "ACT_BUSY_SIT_GROUND"
...
NPCAnim.CombineOWModels =
{
	...
	"models/dessert_ce/combine_super_soldier.mdl",
	"models/combine_special.mdl"
}
...
function NPCAnim.SetPlayerAnimation( ply, weapanim )
	...
	if ( ply:InVehicle() ) then
		if ( ply:GetVehicle():GetClass() == "prop_vehicle_jeep" or ply:GetVehicle():GetClass() == "prop_vehicle_airboat" ) then
			seqname = "crouch"
		else
			seqname = "sit"
		end
