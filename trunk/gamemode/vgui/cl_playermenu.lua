...
PropertySheet:SetSize( DermaPanel:GetWide() - 5, DermaPanel:GetTall() - 33 )
	...
	for k, v in pairs( Inventory ) do
		...
		local WeightLabel = vgui.Create( "DLabel", InventoryDPanel )
		WeightLabel:SetPos( 225, 48 )
		WeightLabel:SetText( "Weight: " .. Items[ k ].Weight * v  )
		WeightLabel:SetFont( "ChatFont" )
		WeightLabel:SetTextColor( Color( 150, 0, 0, 255 ) )
	...
	for k, v in pairs( Items ) do
		if ( LocalPlayer().Business == 1 and v.Business ) then
			...
			local WeightLabel = vgui.Create( "DLabel", ShopDPanel )
			WeightLabel:SetPos( 150, 48  )
			WeightLabel:SetText( "Weight: " .. Items[ k ].Weight )
			WeightLabel:SetFont( "ChatFont" )
			WeightLabel:SetTextColor( Color( 255, 0, 0, 255 ) )
			WeightLabel:SizeToContents()
			...
			CostLabel:SetTextColor( Color( 0, 150, 0, 255 ) )
